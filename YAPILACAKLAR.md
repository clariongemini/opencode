...
| F0.8 | [EK-20260920] opencode yapısının ve mimarinin github reposuna yüklenmesi (`clariongemini/opencode`): AGENTS.md, opencode.json, `.opencode/` (commands + skills), `standards/`, YAPILACAKLAR.md; `node_modules` hariç | overmind | geliştirici | push çıktısı + remote doğrulama | işleniyor |
