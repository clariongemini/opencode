...
| F16.2.3 | SSS: `sss_sorulari` + `sss_cevirileri` 6 dil; SEO title/desc bantlı; JSON-LD FAQ; admin API doğrulaması | overmind | geliştirici | DB count + band + API/HTML + rapor | işleniyor |
