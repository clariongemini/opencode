...
**Durum:** active · 2026-09-24 — F16.1 `tamamlandı`; **F16.2 `işleniyor`** (F16.2.1–F16.2.3, F16.2.5, F16.2.8–F16.2.9 `tamamlandı`; F16.2.4/F16.2.6–F16.2.7/F16.2.10–F16.2.11 `bekliyor`); F16.3–F16.6 `bekliyor` · docs envanter: `docs/F16.2-durum-ve-eksikler.md`
