...
| [EK-20260924] F16.2.4 | Blog: `blog_yazilari` + `blog_yazisi_cevirileri` seed × 6 dil + SEO band + admin CRUD + `blog.php` HTML | overmind | geliştirici | DB count + band + API/HTML + rapor | tamamlandı — Şema normalizasyonu tamamlandı (000045) |
