...
use Kamelya\Services\BlogService;
...
final class BlogController
{
    ...
    public function __construct()
    {
        ...
        $this->service = new BlogService($pdo, new BlogRepository($pdo));
    }
    ...
    public function liste(Request $istek, array $rota = []): void
    {
        ...
        $sonuc = $this->service->liste($dil, $sayfa, $adet);
        Response::basari($sonuc['satirlar'], ['sayfa' => $sayfa, 'limit' => $adet, 'toplam' => $sonuc['toplam']]);
    }
